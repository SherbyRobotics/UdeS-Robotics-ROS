...
class planif(object):
    ...
    def getparam(self):
        ...
        self.t_MB_A = rospy.get_param("~t_MB_A", 20) #Targeted current (A) for MotorB
        ...
        self.t_MB_T = rospy.get_param("~t_MB_r", 15) #Targeted Torque (Nm) for MotorB
