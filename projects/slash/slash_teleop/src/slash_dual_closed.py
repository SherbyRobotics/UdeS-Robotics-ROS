...
class teleop(object):
    ...
    def joy_callback( self, joy_msg ):
        ...
        #If left trigger is active --> CC1 openloop in Torque       
            ...
            # For logitech joystick
            #mapping button --> cmd
            cmd_msg.linear.x = 400  #Motor A Targeted at 700 rad/s
            cmd_msg.linear.y = 0    #Motor B
            cmd_msg.linear.z = 5                   #CtrlChoice
            ...
            # For logitech joystick
            #mapping button --> cmd
            cmd_msg.linear.x = 700  #Motor A Targeted at 700 rad/s
            cmd_msg.linear.y = 0    #Motor B
            cmd_msg.linear.z = 6                   #CtrlChoice
